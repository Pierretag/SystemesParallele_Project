...
protected :
    ...
    void updateLabelP(uint32_t **E, int i0, int i1, int j0, int j1, uint32_t* T);
...
public :
    ...
    void reDoLabel4C(int i, uint32_t **E, uint32_t* T, int largeur);
    void reDoLabel8C(int i, uint32_t **E, uint32_t* T, int largeur);
